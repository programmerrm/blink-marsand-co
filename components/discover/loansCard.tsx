...
export default function LoansCard() {
    return (
        <div className=" bg-[#004737] rounded-3xl sm:rounded-[40px] flex flex-col lg:flex-row justify-between gap-5 relative ">
            <div className="order-2 lg:order-1 w-full lg:max-w-2xl pr-6 lg:pr-0 py-6 lg:py-12 pl-6 lg:pl-12">
                <h3 className=" leading-8 sm:leading-10 xl:leading-15 text-white">Loans & Deposits</h3>
                <p className="text-base lg:text-xl font-normal opacity-80 mt-5 text-white">Gain valuable insights into your spending habits with Blink intelligent analysis tools. Understand where your money is going, receive personalized recommendations for saving, and make informed financial decisions to achieve your goals faster.</p>

                <div className="w-fit bg-[linear-gradient(90deg,#3AC2D6_-2.38%,#59C4AB_15.62%,#7EC779_40.62%,#99CA54_62.62%,#A9CB3E_79.62%,#B0CC36_90.62%,#B0CC36_97.62%)] p-px rounded-full mt-10 sm:mt-34">
