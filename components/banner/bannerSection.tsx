                ...
                <div className="container">
                    <div className="flex flex-col md:flex-row justify-between gap-5 md:gap-16 ">
                        ...
                        <div ref={leftSideRef} className="w-full md:max-w-181.5 pt-2 pb-10">
                            <Link href="#" className="bg-[#FBF8E9] flex items-center justify-between gap-1.5 md:gap-2 w-fit px-4 md:px-6 py-2 sm:py-3 rounded-full text-xs md:text-base font-medium leading-5 mb-6 left-item"><span>Be first to know when Blink goes live</span>
                            ...
                            <h1 className="left-item">Banking, reimagined for the way Bangladesh moves.</h1>
